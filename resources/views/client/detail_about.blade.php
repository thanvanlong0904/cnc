...
<head>
  ...
  <title>CNC Anh Đức chuyên chia công cơ khí chính xác cao.</title>
  <meta content="" name="Công ty anh đức chuyên gia công các chi tiết máy, chính xác, chất lượng uy tín hàng đầu việt nam">
  <meta content="" name="CNC Anh Đức chuyên chia công cơ khí chính xác cao.">
  <meta property="og:image" content="  {{asset($about->img)}}" />
  <meta property="og:image:secure_url" content=" {{asset($about->img)}}" />
        ...
        <div class="row">
          <div class="col-md-8" style="text-align: justify;">
           ...
           <?php $language = Session()->get('website_language', config('app.locale'));
                                    ...
                                    if ($language == 'en') {
                                        echo $about->detail_en;
                                    }
                                    if ($language == 'ja') {
                                        echo  $about->detail_ja;
                                    }        ?>
          </div>
          ...
          <div class="col-md-4 menu-list-post d-none d-md-block">
            <div class="row">
              ...
              <div class="col-md-12 py-2 item">
                <div class="row">
                  <div class="col-md-3">
                    <a href="{{route('product.list',[$list->slug,$list->id])}}"><img class="img-fluid" src="{{asset($list->img)}}" alt=""> </a>
                  </div>
                  <div class="col-md-8" style="font-weight: bold;"><a href="{{route('product.list',[$list->slug,$list->id])}}"> 
                  <?php $language = Session()->get('website_language', config('app.locale'));
                                    if ($language == 'vi') {
                                        echo  $list->name;
                                    };
         ...
         @foreach($list_services as $list)
          <div class="item">
            <div style="padding:0px 5px ; box-sizing: border-box;">
              <a href="{{route('product.list',[$list->slug,$list->id])}}">

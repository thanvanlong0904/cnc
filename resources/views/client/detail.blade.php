...
<head>
  ...
  <meta content="" name="{{$details->name}}">
  <meta property="og:image" content="  {{asset($details->img)}}" />
  <meta property="og:image:secure_url" content="  {{asset($details->img)}}" />
  ...
  <main id="list-post-detail">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="col-12">
            <img class="img-fluid img-main-detail" src="{{asset($details->img)}}" alt="">
          </div>
          <div class="col-12 meta_showing">
            <div class="content-meta_showing">
              <span> <?php $language = Session()->get('website_language', config('app.locale'));
                      ...
                      if ($language == 'ja') {
                        echo  "製品";
                      }        ?> </span> <span>/</span> <span>{{$details->created_at->format('d-m-y')}}</span>
            </div>
          </div>
          <div class="content-detail-post">
            <div class="title">
              ...
              if ($language == 'en') {
                echo  $details->name_en;
              }
              if ($language == 'ja') {
                echo  $details->name_ja;
              }        ?>
            </div>
            <strong class="mb-5">
            <?php $language = Session()->get('website_language', config('app.locale'));
            ...
            <div class="detail mt-3">
              ...
              if ($language == 'en') {
                echo  $details->desc_en;
              }
              if ($language == 'ja') {
                echo  $details->desc_ja;
              }        ?>
            </div>
            ...
            <div class="col-12 mt-3">
              <img class="img-fluid img-main-detail" src="{{asset($details->img1)}}" alt="">
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 menu-list-post d-none d-md-block">
          <div class="row">
            ...
            <div class="col-md-12 py-2 item">
              <div class="row">
                <div class="col-md-3">
                  <a href="{{route('product.detail',[$list->slug,$list->id])}}"><img class="img-fluid" src="{{asset($list->img)}}" alt=""> </a>
                </div>
                <div class="col-md-8" style="font-weight: bold;"><a href="{{route('product.detail',[$list->slug,$list->id])}}">
                    <?php $language = Session()->get('website_language', config('app.locale'));
                    if ($language == 'vi') {
                      echo $list->name;
                    };
          ...
          <div class="owl-carousel owl-carousel4 owl-theme">
            ...
            <div class="item">
              <div style="padding:0px 5px ; box-sizing: border-box;">
                <a href="{{route('product.detail',[$list->slug,$list->id])}}">

...
<head>
  ...
  <title> {{$banner_detail->name}}</title>
  <meta content="" name="Công ty anh đức chuyên gia công các chi tiết máy, chính xác, chất lượng uy tín hàng đầu việt nam">
  <meta content="" name="{{$banner_detail->name}}">
  <meta property="og:image" content="  {{asset($banner_detail->image)}}" />
  <meta property="og:image:secure_url" content="  {{asset($banner_detail->image)}}" />
  ...
  <main id="list-post-detail">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="col-12">
            <img class="img-fluid img-main-detail" src="{{asset($banner_detail->image)}}" alt="">
          </div>
          <div class="col-12 meta_showing">
            <div class="content-meta_showing">
              <span> <?php $language = Session()->get('website_language', config('app.locale'));
                      if ($language == 'vi') {
                        echo "Banner";
                      };
                      if ($language == 'en') {
                      ...
                      if ($language == 'ja') {
                        echo  "バナー";
                      }        ?> </span> <span>/</span> <span>{{$banner_detail->created_at->format('d-m-y')}}</span>
            </div>
          </div>
          <div class="content-detail-post">
            <div class="title">
              <?php $language = Session()->get('website_language', config('app.locale'));
              if ($language == 'vi') {
                echo  $banner_detail->name;
              };
              if ($language == 'en') {
                echo  $banner_detail->name_en;
              }
              if ($language == 'ja') {
                echo  $banner_detail->nam_ja;
              }        ?>
            </div>
            <strong class="mb-5">
            <?php $language = Session()->get('website_language', config('app.locale'));
            ...
            <div class="detail mt-3">
              ...
              <?php $language = Session()->get('website_language', config('app.locale'));
              if ($language == 'vi') {
                echo  $banner_detail->desc;
              };
              if ($language == 'en') {
                echo  $banner_detail->desc_en;
              }
              if ($language == 'ja') {
                echo  $banner_detail->desc_ja;
              }        ?>
            </div>
            ...
            <div class="detail mt-3">
              <?php $language = Session()->get('website_language', config('app.locale'));
              if ($language == 'vi') {
                echo  $banner_detail->detail;
              };
              if ($language == 'en') {
                echo  $banner_detail->detail_en;
              }
              if ($language == 'ja') {
                echo  $banner_detail->detail_ja;
              }        ?>
            </div>
        ...
        <div class="col-md-4 menu-list-post d-none d-md-block">
          <div class="row">
            <h4><?php $language = Session()->get('website_language', config('app.locale'));
                if ($language == 'vi') {
                  echo "Danh sách banner";
                };
                if ($language == 'en') {
                  echo  "List of banners";
                }
                if ($language == 'ja') {
                  echo  "バナー一覧";
                }        ?></h4>
            ...
            <div class="col-md-12 py-2 item">
              <div class="row">
                <div class="col-md-3">
                  <a href="{{route('banner.detail',[$list->slug,$list->id])}}"><img class="img-fluid" src="{{asset($list->image)}}" alt=""> </a>
                </div>
                <div class="col-md-8" style="font-weight: bold;"><a href="{{route('banner.detail',[$list->slug,$list->id])}}">
                    <?php $language = Session()->get('website_language', config('app.locale'));
                    if ($language == 'vi') {
                      echo $list->name;
                    };
        ...
        <div class="col-12 mt-5 d-md-none">
          <h5 style="font-weight:bold ;"><?php $language = Session()->get('website_language', config('app.locale'));
                                          if ($language == 'vi') {
                                            echo "Danh sách banner";
                                          };
                                          if ($language == 'en') {
          ...
          <div class="owl-carousel owl-carousel4 owl-theme">
            ...
            <div class="item">
              <div style="padding:0px 5px ; box-sizing: border-box;">
                <a href="{{route('banner.detail',[$list->slug,$list->id])}}">
                  <div><img src="{{asset($list->image)}}" alt=""></div>
